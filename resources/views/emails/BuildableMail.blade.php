                    ...
                    <tr>
                        <td align="center">
                            ...
                            <div class="sender" style="color: #04001d; margin: 50px 0">
                                ...
                                <p style="font-size: 18px; margin: 1rem 2rem 1rem" class="date">Tel/Wa:  <a style="font-weight: 800; color: #04001d; text-decoration:none" href={{"tel:" . $content_mail['admin_phone']}}>{{$content_mail['admin_phone']}}</a></p>

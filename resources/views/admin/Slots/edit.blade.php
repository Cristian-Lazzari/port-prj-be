...
@endif
    ...
    <h1 class="my-3">
        ...
        Modifica Slot {{$slot->name}}
    </h1>
    <form action="{{ route('admin.slots.update', $slot) }}"  enctype="multipart/form-data"  method="POST">
        @method('PUT')
        @csrf
        <section class="modal-body">
            ...
            <div class="split">    
                <div>
                    ...
                    <p>
                        <input value="{{ old('name', $slot->name) }}" type="text" name="name" id="name" placeholder="Inserisci il nome">
                    </p>
                ...
                <div>
                    ...
                    <p>
                        <input class="w-100" value="{{ old('price', $slot->price) }}" type="text" name="price" id="price" placeholder="Inserisci il prezzo ">
                    </p>
            ...
            <div class="split">          
                <div>
                    ...
                    <p>
                        <input value="{{ old('loa', $slot->loa) }}" type="number" name="loa" id="boat-width" placeholder="Inserisci la LOA">
                    </p>
        ...
        <input type="hidden" name="rotation" id="rotation" value="{{$slot->rotation}}">
        <input type="hidden" name="length" id="length-hidden" value="{{$slot->loa}}">
        <input type="hidden" name="width" id="width-hidden" value="{{$slot->beam}}">
